...
Также необходим бекенд, который будет отвечать за составление плана сборки файла из чанков, авторизации и отдаче пользователю метаданных о файлах
(список файлов, директорий, размер, дата создания, ...).
